/**
 * Overview - OmniFocus Database Statistics Plugin
 *
 * Displays comprehensive overview of OmniFocus database with detailed breakdowns
 * of tasks, projects, folders, tags, inbox items, and key statistics.
 */
...
(() => {
    ...
    function buildOverviewMessage(taskStats, projectStats, folderCount, tagCount, inboxCount, stats) {
        let message = '=== OmniFocus Overview ===\n\n';
    ...
    const action = new PlugIn.Action(function(selection, sender) {
        try {
            ...
            const alert = new Alert('OmniFocus Overview', message);
            alert.show();
