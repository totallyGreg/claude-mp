...
REFERENCE_CATALOG_TEMPLATE = """# Reference Catalog

Last updated: {date}

This catalog indexes all reference documentation in this skill.

## Quick Reference

- **example_reference.md** - Example reference documentation placeholder

## Detailed Index

### example_reference.md
**Size**: TBD | **Lines**: TBD | **Topics**: TBD
**Purpose**: Replace with actual reference documentation
**When to use**: When you need detailed reference information
**Key sections**: TBD

## Consolidation Status

No references yet. Run `python3 ../../skillsmith/scripts/update_references.py .` after adding references.

---

*This catalog is automatically generated by `scripts/update_references.py`. To regenerate: `python3 ../../skillsmith/scripts/update_references.py .`*
"""
...
def init_skill(skill_name, skills_dir):
    ...
    try:
        ...
        # Create REFERENCE.md catalog
        reference_catalog = references_dir / "REFERENCE.md"
        from datetime import datetime
        reference_catalog.write_text(REFERENCE_CATALOG_TEMPLATE.format(
