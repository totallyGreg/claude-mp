...
| **marketplace-manager** | 2.7.0 | Manages Claude Code plugin marketplace operations including version syncing, skill publishing, and marketplace.json maintenance |
| **skillsmith** | 6.4.0 | Guide for forging effective Claude skills with marketplace integration |
...
| **omnifocus-manager** | 8.3.0 | Interface with OmniFocus to surface insights, create reusable automations and perspectives, and suggest workflow optimizations |
