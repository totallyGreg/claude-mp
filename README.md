...
| **marketplace-manager** | 2.8.0 | Manages Claude Code plugin marketplace operations including version syncing, skill publishing, and marketplace.json maintenance |
| **skillsmith** | 6.5.1 | Guide for forging effective Claude skills with marketplace integration |
...
| **omnifocus-manager** | 9.3.1 | Interface with OmniFocus to surface insights, create reusable automations and perspectives, and suggest workflow optimizations |
| **pkm-plugin** | 1.8.0 | Personal Knowledge Management expert for Obsidian vaults with dual-skill architecture: vault-architect (create structures) and vault-curator (evolve content) |
