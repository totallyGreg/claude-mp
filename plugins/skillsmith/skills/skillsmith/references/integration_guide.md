...
4. Skillsmith creates GitHub Issue
   ...
   ↓
5. Skillsmith updates plugin README.md
...
10. marketplace-manager syncs and commits
    ...
    - Asks about push → YES
    ↓
11. Skillsmith updates plugin README.md
...
- Follows WORKFLOW.md pattern (GitHub Issue + plugin README.md)
...
3. Updates plugin README.md status to reflect blockage
...
4. Update plugin README.md metrics
