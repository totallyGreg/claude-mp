...
allowed-tools: Bash(${CLAUDE_PLUGIN_ROOT}/skills/omnifocus-core/scripts/weekly-review-collect.sh), Bash(date:*), Bash(osascript:*), Bash(pbcopy:*), Write
---
...
!`"${CLAUDE_PLUGIN_ROOT}/skills/omnifocus-core/scripts/weekly-review-collect.sh"`
...
3. Append to OmniFocus Weekly Review task note:
   `osascript -l JavaScript "${CLAUDE_PLUGIN_ROOT}/skills/omnifocus-core/scripts/update-weekly-note.js" "/tmp/of-weekly-review.md"`
