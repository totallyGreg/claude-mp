...
// D6.2 — Omni Automation global for moving projects/folders (sections) between containers
declare function moveSections(sections: Array<Project | Folder>, position: any): void;
