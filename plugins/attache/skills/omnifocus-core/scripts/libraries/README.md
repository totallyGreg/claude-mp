...
The omnifocus-core skill uses these libraries to EXECUTE automation instead of generating code:
...
Part of the omnifocus-core skill. See parent directory for license information.
