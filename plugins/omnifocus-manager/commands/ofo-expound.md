...
allowed-tools: Bash(${CLAUDE_PLUGIN_ROOT}/skills/omnifocus-manager/scripts/*), AskUserQuestion
---
...
```bash
"${CLAUDE_PLUGIN_ROOT}/skills/omnifocus-manager/scripts/ofo" info "<task-id>"
```
...
- Available tags to apply (fetch from: `"${CLAUDE_PLUGIN_ROOT}/skills/omnifocus-manager/scripts/ofo" tags`)
...
**Rename:**
```bash
"${CLAUDE_PLUGIN_ROOT}/skills/omnifocus-manager/scripts/ofo" update "<id>" --name "<new name>"
```

**Add tag:**
```bash
"${CLAUDE_PLUGIN_ROOT}/skills/omnifocus-manager/scripts/ofo" tag "<id>" --add "<tag>"
```
