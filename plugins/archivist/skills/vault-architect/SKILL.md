...
- **Notation Conventions** — the notation choice used in this vault's new templates (see Design Principles). Record the chosen markers here so future template work is consistent. Plugin dependencies (e.g., Tasks plugin for extended task states) belong on this line.
